      ...
      >
        <div className="field-body">
          <Field label="frame width">
            <Input
              changeEvent={this.handleSetWidth}
              cls="input is-small"
          ...
          <Field label="frame height">
            <Input
              changeEvent={this.handleSetHeight}
              cls="input is-small"
          ...
          <Field label="select algorithm">
            <Select
              changeEvent={this.handleSetBinAlgo}
              options={this.state.bin_algos}
            />
          </Field>
          <Field label="packing algorithm">
            <Select
              changeEvent={this.handleSetPackAlgo}
              options={this.state.algorithms}
            />
          </Field>
          <Field label="sort">
            <Select
              changeEvent={this.handleSetHeuristic}
              options={this.state.heuristics}
            />
          </Field>
          <Field label="sorting rules">
            <Select
              changeEvent={this.handleSetSorting}
              options={this.state.sorting}
            />
          </Field>
          {this.props.state.settings.pack_algo === "shelf" ||
          this.props.state.settings.pack_algo === "skyline" ? (
            <Field label="wastemap">
              <Select
                changeEvent={this.handleSetWastemap}
                options={["True", "False"]}
              />
            </Field>
          ) : null}
          {this.props.state.settings.pack_algo === "guillotine" ? (
            <Field label="rectangle merge">
              <Select
                changeEvent={this.handleSetRectangleMerge}
                options={["True", "False"]}
              />
            </Field>
          ) : null}
